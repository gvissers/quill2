...
OBJS = main.o Basis.o BasisSet.o boys.o BFQuadPool.o CGTO.o CGTOPair.o \
	...
	CGTOSpecPair.o CommentFilter.o DIIS.o Dispatcher.o Element.o FmCoefs.o \
	Geometry.o HartreeFock.o IndentFilter.o JobFilter.o LineIStream.o \
	manipulators.o PeriodicTable.o quillmath.o support.o XYZMatrix.o \
	ZMatrix.o
