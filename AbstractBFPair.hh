...
class AbstractBFPair
{
	public:
		 ...
		 *
		 * Compute the overlap between the two functions in this pair.
		 * The default implementation in this class calls
		 * oneElectron(), and returns only the overlap. This function
		 * can be overridden by potentially more efficient methods in
		 * classes deriving from AbstractBFPair.
		 */
		 ...
		 *
		 * Compute the kinetic energy integral between the two functions
		 * in this pair. The default implementation in this class calls
		 * oneElectron(), and returns only the kinetic energy. This
		 * function can be overridden by potentially more efficient
		 * methods in classes deriving from AbstractBFPair.
		 */
		 ...
		 * two functions in this pair. Child classes should implement
		 * this function.
